...
/**
 calculates (returns via getMoves method) all possible moves for a Queen from a starting position.
 */
public class QueenMoves {
    ...
    public QueenMoves(ChessPosition startingPosition, ChessBoard board, ChessGame.TeamColor color) {
